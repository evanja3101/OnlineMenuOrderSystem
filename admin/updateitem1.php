<?php
	...
	$query = "SELECT * FROM `menu_items` WHERE `id` = $sid";
		...
		<table align="center" style="margin-top: 50px; " cellpadding="3">
			<form action="updateitem2.php" method="post" enctype="multipart/form-data">
				...
				<tr>
					<td>Type</td>
					<td>
						<input type="text" name="type" value="<?php echo $data['category']; ?>" required>
					</td>
				</tr>
				<tr>
					<td>Detail</td>
					<td>
						<textarea cols="22" name="detail" required=""><?php echo $data['description']; ?></textarea>
					</td>
				</tr>
				<tr>
					<td>Price</td>
