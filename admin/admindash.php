...
<body>
	...
	<div align="center" class="mt-5 abc" style="padding-top: 50px;">
		...
		<a href="menudb.php"><button class="btn btn-lg btn-primary">MENU OVERVIEW</button></a><br><br>
		<a href="orderdetail.php"><button class="btn btn-lg btn-primary">ORDER DETAIL</button></a><br><br>
		<a href="customerdb.php"><button class="btn btn-lg btn-primary">USER SUBSCRIPTION</button></a>
		<br>
		<br>
		<a href="qrcode_generation.php"><button class="btn btn-lg btn-primary">QR CODE MANAGEMENT</button></a>
	</div>
