...
<?php
	...
	if (isset($_POST['submit'])) 
	{
		...
		$esql = "SELECT 1 FROM `user_register` WHERE `email` = '$email'";
		...
		$sql = "INSERT INTO `user_register`(`name`, `mobile`, `address`, `email`, `password`) VALUES ('$name', '$mobile', '$address', '$email', '$password')";
